...
async function main() {
  ...
  const payload = {
    ...
    pdfWorkerResolvedPath: result.pdfWorkerResolvedPath,
    pdfWorkerExists: result.pdfWorkerExists,
    pdfWorkerSrc: result.pdfWorkerSrc,
    pdfjsImportMode: result.pdfjsImportMode,
    textExtractionInfrastructureStage: result.textExtractionInfrastructureStage,
