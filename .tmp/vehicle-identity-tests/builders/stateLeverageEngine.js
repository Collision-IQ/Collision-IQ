...
exports.buildStateLeverage = buildStateLeverage;
function buildStateLeverage(state) {
    if (!state) {
        return {
            points: [
    ...
    return {
        ...
        disclaimer: "Add state-specific claim handling language if local counsel or policy review supports it.",
    };
}
