...
exports.analyzeEstimateOperations = analyzeEstimateOperations;
exports.hasEstimateOperation = hasEstimateOperation;
exports.inferImpactSide = inferImpactSide;
exports.isOperationAlreadyRepresented = isOperationAlreadyRepresented;
...
function analyzeEstimateOperations(text) {
...
function hasEstimateOperation(text, key) {
    return OPERATION_PATTERNS[key].some((pattern) => pattern.test(text));
}
function inferImpactSide(text) {
...
function isOperationAlreadyRepresented(text, operation) {
