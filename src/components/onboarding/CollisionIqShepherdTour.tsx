...
function buildTour() {
  ...
  const targets: TourTarget[] = [
    ...
    },
    {
      id: "command-center",
      title: "Navigation",
      text: "Use the sidebar to move between the Analysis Workspace, evidence, vehicle details, history, knowledge base, and settings. A red dot appears on a section whenever it has something new for you.",
