...
function buildTour() {
  ...
  const targets: TourTarget[] = [
    ...
    },
    {
      id: "command-center",
      title: "Navigation",
      text: "Use the sidebar to move around: Analysis Workspace for chat and live reviews, Reports for generated documents, plus Evidence, My Vehicle, Scan IQ, History, Knowledge Base, and Settings. A red dot on any section means something new is waiting for you there.",
    ...
    },
    {
      id: "report-center",
      title: "Reports",
      text: "Generated reports — Snapshot, Repair Intelligence, Delta and OEM Citation Density, DOI Complaint Packet, and Customer Report — open in this tab the moment they're ready. A red dot and a pop-up let you know when new reports are available, while your chat stays open in the Analysis Workspace.",
    ...
    },
    {
      id: "my-vehicle",
      title: "My Vehicle",
      text: "Add your vehicle details here so Collision IQ can tailor repair, maintenance, and safety guidance to the correct vehicle. Start with the VIN when available so the system can decode the year, make, model, and configuration. A red dot appears here when maintenance or safety-related service may be due.",
    ...
    },
    {
      id: "scan-iq",
      title: "Scan IQ",
      text: "Scan IQ compares pre- and post-repair scan reports: upload both and it extracts the DTCs, shows what cleared, what remains, and what appeared during repair.",
      selectors: ['[data-tour="nav-scan-iq"]'],
      desktopPlacement: "right",
      mobilePlacement: "bottom",
    },
    {
      ...
      selectors: ['[data-tour="nav-history"]'],
      desktopPlacement: "right",
      mobilePlacement: "bottom",
    },
    {
    ...
    },
    {
      ...
      text: "Your latest saved reports surface right here in the workspace — click one to jump straight into its detail in History.",
      selectors: ['[data-tour="recent-reports"]'],
