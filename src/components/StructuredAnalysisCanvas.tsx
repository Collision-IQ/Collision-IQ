      ...
      {canRenderExports ? (
        ...
        >
          <AnalysisSectionCard
            ...
            preview={
              canUseFullReportExports
                ? "Repair Intelligence Report, Citation Density Gap Report, and Policy & Rights Review remain available in the rail."
          ...
          >
            <div className="border border-border bg-muted px-3 py-2.5 text-[13px] leading-5 text-muted-foreground">
              {canUseFullReportExports
                ? "Use the rail to generate the Repair Intelligence Report, Citation Density Gap Report, or Policy & Rights Review."
