...
- Do not say "shop estimate is correct", "carrier estimate is wrong", "shop is right", or equivalent whole-estimate winner language unless each disputed item is independently supported.
